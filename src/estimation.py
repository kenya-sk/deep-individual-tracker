...
def estimation(modelPath):
    ...
    W_conv1 = tf.get_variable("conv1/weight1", shape=[7,7,3,32])
    ...
    W_conv2 = tf.get_variable("conv2/weight2", shape=[7,7,32,32])
    ...
    W_conv3 = tf.get_variable("conv3/weight3", shape=[5,5,32,64])
    ...
    W_fc4 = tf.get_variable("fc4/weight4", shape[18*18*64, 1000])
